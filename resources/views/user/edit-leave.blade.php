...
@section('content')
    <h1 class="text-3xl font-bold mb-8 text-center">Edit Leave Request</h1>

    <form action="{{ route('leave.update', $leave->id) }}" method="POST"
        class="max-w-md mx-auto bg-white shadow-lg rounded-lg p-8">
        @csrf
        @method('PUT') <!-- Add this line to indicate a PUT request for updates -->
        ...
        <div class="mb-6">
            ...
            <input type="text" id="type" name="type"
                ...
                value="{{ old('type', $leave->type) }}" required placeholder="Enter leave type (e.g., Vacation)">
            @error('type')
