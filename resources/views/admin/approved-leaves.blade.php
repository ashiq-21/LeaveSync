...
@section('content')
    <div class="container mx-auto">
        <h1 class="text-3xl font-bold mb-6">Approved Leaves</h1>
        ...
        @if ($leaves->isEmpty())
            <div class="bg-yellow-100 text-yellow-800 p-4 rounded-md mb-6 text-center">
                <p class="text-lg font-semibold">No Approved leaves at the moment.</p>
            </div>
        @else
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <div class="flex space-x-2">
                                        <form action="{{ route('admin.deny-leave', $leave->id) }}" method="POST"
                                            class="inline">
                                            @csrf
                                            <button type="submit"
